export const generateMiddleware = () => {
    return {
        ...
        createActivity: async (activityData, email, password) => {
            try {
        ...
        editContent: async (activityData, email, password) => {
            try {
                const response = await fetch("/edit-activity", {
                    headers: {
                        "Content-Type": "application/json"
                    },
                    method: "PUT",
                    body: JSON.stringify({
                        contentactivityDataData: activityData,
                        email: email,
                        password: password
                    })
                });
        ...
        deleteActivity: async (activityId, email, password) => {
            try {
